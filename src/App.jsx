...
function App() {
  const data=[
    ...
    },
    {
      "id": "2",
      "name": "Thuppaki",
      "poster": "https://resizing.flixster.com/g_fVwyqH3bjWmN6KQpgAnUO6fg0=/206x305/v2/https://flxt.tmsimg.com/assets/p9561344_p_v8_ab.jpg",
      "rating": "8.1",
    ...
    },
    {
        ...
        "trailer":"https://www.youtube.com/watch?v=fWajtP80g54"
      },
    {
      "id": "6",
      "name": "Theri",
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path='/don/:id' element={<Don data={data}/>}/>
      </Routes>
      </BrowserRouter>
    </div>
  )
